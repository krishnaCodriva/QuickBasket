...
,
  ...
  hinglish: {
    ...
    auth: {
      ...
      resendOtp: 'Resend OTP',
      verifyOtp: 'Verify OTP',
      invalidOtp: 'Invalid OTP. Kripya phir se try karein.',
      expiredOtp: 'OTP expire ho gaya. Kripya naya request karein.',
      networkError: 'Network error. Kripya phir se try karein.',
      loginTab: 'Login',
      signUpTab: 'Sign Up',
      fullName: 'Pura Naam',
      email: 'Email ID',
      ...
      missingFields: 'Kripya sabhi jaroori fields bharein.',
      invalidEmail: 'Kripya sahi email address daalein.',
      passwordLength: 'Password kam se kam 6 characters ka hona chahiye.',
    },
    checkoutScreen: {
      title: 'Checkout Page',
      emptyCart: 'Aapka cart khali hai.',
...
,
  ...
  ml: {
    ...
    auth: {
      ...
      missingFields: 'ദയവായി നിർബന്ധിത ഫീൽഡുകൾ പൂരിപ്പിക്കുക.',
      invalidEmail: 'ദയവായി സാധുവായ ഇമെയിൽ നൽകുക.',
      passwordLength: 'പാസ്‌വേഡ് കുറഞ്ഞത് 6 പ്രതീകങ്ങൾ ഉണ്ടായിരിക്കണം.',
    },
    checkoutScreen: {
